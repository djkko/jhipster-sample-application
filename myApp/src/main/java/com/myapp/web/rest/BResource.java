                ...
                Mono<B> result = bRepository
                    ...
                    .map(existingB -> {
                        if (b.getAppName() != null) {
                            existingB.setAppName(b.getAppName());
                        }
                        if (b.getAppIcon() != null) {
                            existingB.setAppIcon(b.getAppIcon());
                        }
                        if (b.getAppIconContentType() != null) {
                            existingB.setAppIconContentType(b.getAppIconContentType());
                        }
