...
public class AResource {
     ...
     */
    @PostMapping("/as")
    public Mono<ResponseEntity<A>> createA(@Valid @RequestBody A a) throws URISyntaxException {
     ...
     */
    @PutMapping("/as/{id}")
    public Mono<ResponseEntity<A>> updateA(@PathVariable(value = "id", required = false) final Long id, @Valid @RequestBody A a)
    ...
    public Mono<ResponseEntity<A>> partialUpdateA(@PathVariable(value = "id", required = false) final Long id, @NotNull @RequestBody A a)
        throws URISyntaxException {
        ...
        return aRepository
            ...
            .flatMap(exists -> {
                ...
                Mono<A> result = aRepository
                    .findById(a.getId())
                    .map(existingA -> {
                        if (a.getOrderNo() != null) {
                            existingA.setOrderNo(a.getOrderNo());
                        }
                        if (a.getName() != null) {
                            existingA.setName(a.getName());
                        }
                        if (a.getCode() != null) {
                            existingA.setCode(a.getCode());
                        }
