...
public class BRowMapper implements BiFunction<Row, String, B> {
    ...
    public B apply(Row row, String prefix) {
        ...
        entity.setAppIconContentType(converter.fromRow(row, prefix + "_app_icon_content_type", String.class));
        entity.setAppIcon(converter.fromRow(row, prefix + "_app_icon", byte[].class));
