...
export const A = (props: RouteComponentProps<{ url: string }>) => {
  const dispatch = useAppDispatch();

  const aList = useAppSelector(state => state.a.entities);
        ...
        {aList && aList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="myApp.a.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="myApp.a.orderNo">Order No</Translate>
                </th>
                <th>
                  <Translate contentKey="myApp.a.name">Name</Translate>
                </th>
                <th>
                  <Translate contentKey="myApp.a.code">Code</Translate>
                </th>
                <th />
              </tr>
            </thead>
