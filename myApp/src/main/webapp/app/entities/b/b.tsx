              ...
              {bList.map((b, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {b.appIcon ? (
                      <div>
                        {b.appIconContentType ? (
                          <a onClick={openFile(b.appIconContentType, b.appIcon)}>
                            <img src={`data:${b.appIconContentType};base64,${b.appIcon}`} style={{ maxHeight: '30px' }} />
                            &nbsp;
                          </a>
                        ) : null}
                        <span>
                          {b.appIconContentType}, {byteSize(b.appIcon)}
                        </span>
                      </div>
                    ) : null}
                  </td>
