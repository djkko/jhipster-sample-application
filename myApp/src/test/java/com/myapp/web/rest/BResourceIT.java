...
class BResourceIT {
    ...
    void getAllBS() {
        ...
        webTestClient
            ...
            .jsonPath("$.[*].appIconContentType")
            .value(hasItem(DEFAULT_APP_ICON_CONTENT_TYPE))
            .jsonPath("$.[*].appIcon")
            .value(hasItem(Base64Utils.encodeToString(DEFAULT_APP_ICON)));
    }
    ...
    void getB() {
        ...
        webTestClient
            ...
            .jsonPath("$.appIconContentType")
            .value(is(DEFAULT_APP_ICON_CONTENT_TYPE))
            .jsonPath("$.appIcon")
            .value(is(Base64Utils.encodeToString(DEFAULT_APP_ICON)));
    }
