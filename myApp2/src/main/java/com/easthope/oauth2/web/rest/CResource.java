package com.easthope.oauth2.web.rest;

import com.easthope.oauth2.domain.C;
import com.easthope.oauth2.repository.CRepository;
import com.easthope.oauth2.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.easthope.oauth2.domain.C}.
 */
@RestController
@RequestMapping("/api")
@Transactional
