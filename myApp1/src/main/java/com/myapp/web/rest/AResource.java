...
public class AResource {
     ...
     */
    @PutMapping("/as/{id}")
    public ResponseEntity<A> updateA(@PathVariable(value = "id", required = false) final Long id, @Valid @RequestBody A a)
    ...
    public ResponseEntity<A> partialUpdateA(@PathVariable(value = "id", required = false) final Long id, @NotNull @RequestBody A a)
        throws URISyntaxException {
