...
class BResourceIT {
    ...
    private static final byte[] DEFAULT_APP_ICON = TestUtil.createByteArray(1, "0");
    private static final byte[] UPDATED_APP_ICON = TestUtil.createByteArray(1, "1");
    private static final String DEFAULT_APP_ICON_CONTENT_TYPE = "image/jpg";
    private static final String UPDATED_APP_ICON_CONTENT_TYPE = "image/png";
    ...
    public static B createEntity(EntityManager em) {
        B b = new B().appName(DEFAULT_APP_NAME).appIcon(DEFAULT_APP_ICON).appIconContentType(DEFAULT_APP_ICON_CONTENT_TYPE);
        return b;
    }
    ...
    public static B createUpdatedEntity(EntityManager em) {
        B b = new B().appName(UPDATED_APP_NAME).appIcon(UPDATED_APP_ICON).appIconContentType(UPDATED_APP_ICON_CONTENT_TYPE);
        return b;
    }
    ...
    void createB() throws Exception {
        ...
        assertThat(testB.getAppName()).isEqualTo(DEFAULT_APP_NAME);
        assertThat(testB.getAppIcon()).isEqualTo(DEFAULT_APP_ICON);
        assertThat(testB.getAppIconContentType()).isEqualTo(DEFAULT_APP_ICON_CONTENT_TYPE);
    }
    ...
    void getAllBS() throws Exception {
        ...
        restBMockMvc
            ...
            .andExpect(jsonPath("$.[*].appIconContentType").value(hasItem(DEFAULT_APP_ICON_CONTENT_TYPE)))
            .andExpect(jsonPath("$.[*].appIcon").value(hasItem(Base64Utils.encodeToString(DEFAULT_APP_ICON))));
    }
    ...
    void getB() throws Exception {
        ...
        restBMockMvc
            ...
            .andExpect(jsonPath("$.appIconContentType").value(DEFAULT_APP_ICON_CONTENT_TYPE))
            .andExpect(jsonPath("$.appIcon").value(Base64Utils.encodeToString(DEFAULT_APP_ICON)));
    }
    ...
    void putNewB() throws Exception {
        ...
        em.detach(updatedB);
        updatedB.appName(UPDATED_APP_NAME).appIcon(UPDATED_APP_ICON).appIconContentType(UPDATED_APP_ICON_CONTENT_TYPE);
        ...
        B testB = bList.get(bList.size() - 1);
        assertThat(testB.getAppName()).isEqualTo(UPDATED_APP_NAME);
        assertThat(testB.getAppIcon()).isEqualTo(UPDATED_APP_ICON);
        assertThat(testB.getAppIconContentType()).isEqualTo(UPDATED_APP_ICON_CONTENT_TYPE);
    }
    ...
    void fullUpdateBWithPatch() throws Exception {
        ...
        partialUpdatedB.appName(UPDATED_APP_NAME).appIcon(UPDATED_APP_ICON).appIconContentType(UPDATED_APP_ICON_CONTENT_TYPE);
